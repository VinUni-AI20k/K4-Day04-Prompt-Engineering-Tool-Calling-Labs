...
- Never send asset IDs, employee IDs, serial numbers, hostnames, locations,
  assigned users, diagnostic output, ticket contents or credentials to
  `search_device_info`, in any argument including free-text ones. If a request
