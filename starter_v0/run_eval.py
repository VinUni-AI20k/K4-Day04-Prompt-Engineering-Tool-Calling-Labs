...
def main() -> None:
    ...
    parser.add_argument("--version", default="v0", required=True)
    parser.add_argument("--provider", choices=["openai", "openrouter", "anthropic", "gemini"], default="openai", required=True)
